...
\begin{figure}[t]
\centering
% Sustituir por la imagen del diagrama de arquitectura.
\fbox{\parbox[c][3.2cm][c]{0.92\columnwidth}{\centering
\textit{[Figura: diagrama de arquitectura de 7 módulos.\\
Insertar \texttt{arquitectura.png} con \textbackslash includegraphics]}}}
